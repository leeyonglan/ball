package netServer
{
	...
	public class SSocketMessage
	{
		...
		public function params(index:int = 0):*
		{
			...
			return _rpcHelperObject['rtncode']
		...
		{
			return _rpcHelperObject['message'];
		}
		/**
		 * 返回code 
		 * @return 
		...
		{
			return  _rpcHelperObject['rtncode'] as int;
		}
		/**
		 * 消息版本种子 
		 */
		...
		public static function createMessage2(command:String,params:Dictionary,username:String = null ,md5password:String = null):SSocketMessage
		{
			var msg:SSocketMessage = new SSocketMessage();
			msg.verMajor = curMessageverMajor;
			msg.verMinjor = curMessageVerMinjor;
